...
model_param_dict['activation'] = 'sigmoid'
model = InitModel(name='sigmoid', **model_param_dict)
model.compile(
      optimizer=model.optimizer, 
      loss='categorical_crossentropy',
      metrics=['accuracy']
...
model_param_dict['activation'] = 'tanh'
model = InitModel(name='tanh', **model_param_dict)
model.compile(
      optimizer=model.optimizer, 
      loss='categorical_crossentropy',
      metrics=['accuracy']
