...
impath = './img_1_4_cost_activation/'
...
model = InitModel(name='cat_cross', **model_param_dict)
model.compile(
...
model = InitModel(name='mse', **model_param_dict)
model.compile(
      optimizer=model.optimizer, 
...
plt.savefig(impath + 'cost_function.png')
plt.clf()
