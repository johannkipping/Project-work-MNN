...
from models import DeeperModel, DropoutModel
...
model = DropoutModel(name='dropout_0.2', drop_prob=0.2, **model_param_dict)
model.compile(
      optimizer=model.optimizer, 
      loss='categorical_crossentropy',
      metrics=['accuracy']
...
model = DropoutModel(name='dropout_0.3', drop_prob=0.3, **model_param_dict)
model.compile(
      optimizer=model.optimizer, 
      loss='categorical_crossentropy',
      metrics=['accuracy']
