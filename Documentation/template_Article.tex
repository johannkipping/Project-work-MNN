...
\subsubsection{Activation functions and cost function}
At this point it should be investigated why the baseline net contains the activation and cost function it does. To this end the following was modifications were made and analyzed for the effects in training and validation accuracy:\\
\\
Use \textbf{least squares} as cost function as this was used in the lectures for the first chapters.\\
This lead to\\
\\
Try several activation functions to \textbf{replace ReLU}\\
Sigmoid:
